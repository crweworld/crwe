...
<div class="pull-left"><a href="#">Latest News</a></div>
...
<?php 
$bd = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM posts WHERE post_status='publish' and post_id NOT IN ('" . implode("','",$sldarray) . "') and cat_id!='18'  and cat_id!='25' ORDER BY post_id DESC limit 2") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
<div class="hot-topics-list">
<?php 
$bd = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM posts WHERE post_status='publish' and post_id NOT IN ('" . implode("','",$lat1) . "') and post_id NOT IN ('" . implode("','",$sldarray) . "') and cat_id!='18' and cat_id!='25' ORDER BY post_id DESC limit 2") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
while($info = mysqli_fetch_array( $bd )) 
{ 
									$post_title=($info['post_title']);
									$lat2[]=$info['post_id'];
