...
<link rel='stylesheet prefetch' href='//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css'>
    ...
    <title>Payment Status Success</title>
...
.background {
  ...
  filter: blur(5px);
  background-color: RGBA(0, 170, 102, 0.7);
...
We received your payment, you will soon receive a call from our executive for verification.</p>
						<a href="<?php echo "http://".$_SERVER['HTTP_HOST']?>" class="redo btn">Go Back to HomePage</a>
