...
$post_update=date("Y-m-d") ;
	...
	else
	{
		...
		$update_ok = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE `stock` SET `post_title`='$post_title' , `post_description`='$post_description' , `source_url`='$source_url' , `post_image_loc`='$post_image_loc' , `post_update`='$post_update'  , `post_status`='$post_status' where `post_id`='$post_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		if($update_ok == 1)
		{
			echo "<script>
			alert('Updated Successfully');
			window.location.href='edit_stock.php?stock_id=$post_id';
			</script>";	
		}
	}
}
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <?php
				$edit_post = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM stock where post_id={$_GET['stock_id']}") or die(mysqli_error($GLOBALS["___mysqli_ston"])); 
                ...
                <form role="form" action="" method="post">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="post_title" required="required" value="<?php echo $post_title ?>" placeholder="Enter Title" type="text">
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="edit_post" class="btn btn-primary">Update Stock</button> 
                  </div>
                </form>
