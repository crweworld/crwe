...
<html>
  <head>
    <meta charset="UTF-8">
    <title>CRWEWORLD Investment | Dashboard</title>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img onerror="this.src='/dashboard/crown-logo.png'" src="..<?php echo $_SESSION['pub_pic'];?>" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img onerror="this.src='/dashboard/crown-logo.png'" src="..<?php echo $_SESSION['pub_pic'];?>" class="img-circle" alt="User Image" />
                    <p>
