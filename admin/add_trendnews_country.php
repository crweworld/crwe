...
$count=mysqli_num_rows($sql);
    ...
    /*zippy*/					
		...
		$insert_ok = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `posts`(`cat_id`, `cat_status`, `post_title`, `post_description`, `source_url`, `post_doc`, `post_image_loc`, `post_status`, `post_state`, `post_city`, `post_country`,  `zip_id`, `trend`, `admin_id`) VALUES ( '$cat_id2','$cat_status1', '$post_title', '$post_description', '$source_url', NOW(), '$post_image_loc', '$post_status', '$post_state', '$post_city', '$post_country', '$post_zipid','trend_country', '$admin_id')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		if($insert_ok == 1)
		{	
			$post_id=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);
			
			$post_location=$post_country;
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Create Trending News Country</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Create Trending News Country</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
...
<?php include ('../subs/country_opt.php') ?>
          ...
          <tr id="state" style="visibility:hidden">
            <td>
            <div class="form-group">
            <label>State</label> 
            ...
            <select id="display" name="state"  style="width:100%"  class="form-control" >
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add_post" class="btn btn-primary">Create Trending News Country</button> 
