...
if(isset($_SESSION['group'])){ 
 ...
 include('sidebar.php');
 $admin_id ='';
if(isset($_SESSION['id'])){ $admin_id = $_SESSION['id']; }
...
$count=mysqli_num_rows($sql);
	...
	{	 			
		...
		$insert_ok = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `posts`(`cat_id`, `cat_status`, `post_title`, `post_description`, `source_url`, `post_doc`, `post_image_loc`, `post_status`, `admin_id`) VALUES ( '$cat_id2','$cat_status1', '$post_title', '$post_description', '$source_url', NOW(), '$post_image_loc', '$post_status', '$admin_id')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		if($insert_ok == 1)
		{
