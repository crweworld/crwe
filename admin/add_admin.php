...
if(isset($_POST['add_user']))
{
	...
	$username_sql="SELECT * FROM admin WHERE username='$username'";
	$result=mysqli_query($GLOBALS["___mysqli_ston"], $username_sql);
	...
	elseif($username=="")
	{
		echo "<script>alert('Error!!! Username is Empty');</script>";
	}
	elseif($password=="")
	{
	...
	{	
		...
		$sql="INSERT INTO `admin`(`fname`, `lname`, `subject`, `phone`, `username`, `password`, `doc`, `active`, `group`, `email`, `post_zipid`, `post_city`, `post_state`, `post_country`, `post_zipcode`) VALUES ('$fname','$lname','$subject','$phone','$username','$password','$doc','$active','miniadmin','$email','$post_zipid','$post_city','$post_state','$post_country','$post_zipcode')";	
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Create Mini Admin</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Create Mini Admin</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <h1>&nbsp; Credential Information </h1>    
                    <div class="form-group">
                      ...
                      <input class="form-control" name="username" required="required"  placeholder="User Name" type="text">
                    </div>
                    <div class="form-group">
                ...
                <select id="display2" name="city"  style="width:100%"  class="search2 form-control" >
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add_user" class="btn btn-primary">Create Mini Admin</button> 
