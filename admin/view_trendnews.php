...
/*if (isset($_GET['slider'])and isset($_GET['check']) and ($_GET['check'])!="" )
{
	...
	{
		  $value; 	
		mysql_query("UPDATE `posts` SET `slider`= 'slider' WHERE post_id IN ('" . implode("','",$value) . "')");
	}	
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Trending News</li>
          </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">View Trending News</h3>
                </div><!-- /.box-header -->
                <div class="box-body">         
                ...
                <div class="col-xs-8" style="position: absolute; left: 15%; z-index:10">
                 ...
                 <!-- <div class="col-xs-3"><button type="submit" name="slider" class="btn btn-block btn-info">Add to Slider</button></div>-->
                  ...
                  <input type="text" name="date" style="visibility:hidden" value="<?php $date= $_GET['date']; echo $date?>">
					...
					$posts = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM posts WHERE post_doc BETWEEN CAST('$date1' AS DATE) AND CAST('$date2' AS DATE) and (trend='trend_state' or trend='trend_country' or trend='trend_continent') ORDER BY post_id DESC") or die(mysqli_error($GLOBALS["___mysqli_ston"])); 
					...
					{	
						...
						$post_state=strtoupper($results['post_state']);
					...
					?>
                      ...
                      <td><input class="checkbox1" type="checkbox" name="check[]" value="<?php echo $post_id ?>"  /></td>
                        <td><?php if($slider=="slider"){echo "<i class='fa fa-slideshare'></i>";}?> <a href="edit_trendnews.php?post_id=<?php echo $post_id ?>"><?php echo $post_title ?></a></td>
                        ...
                        <td><?php echo $post_update ?></td>
                         <td><span><?php  if($trend=="trend_state"){echo "State";$location=$post_state;} elseif($trend=="trend_country") {echo "Country";$location=$post_country;}else{ echo 'Continent';$location=$post_continent;}  ?></span></td>
                        ...
                        <td><a href="<?php echo "http://".$_SERVER['HTTP_HOST'].$post_url?>" target="_blank"><i class="fa fa-external-link"></i></a></td>
                      </tr>   
                    <?php }?>                               
                    </tbody>
                    <tfoot>
