      ...
      <div class="content-wrapper">
        ...
        <?php
				...
				while($results = mysqli_fetch_array($edit_post))
				{
				 ...
				 $query = "SELECT SUM(ad_imp),SUM(ad_unq_imp),SUM(ad_clicks),SUM(ad_unq_clicks) FROM ban_loc where ad_id={$_GET['ad_id']}"; 	 
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Ad Stats of <?php echo $ad_title; ?></h3>
                </div><!-- /.box-header -->
                <!-- form start -->                
