      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Local News</li>
          </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">View Local News</h3>
                </div><!-- /.box-header -->
                <div class="box-body">         
                ...
                <div class="col-xs-8" style="position: absolute; left: 15%; z-index:10">
                 ...
                 <!-- <div class="col-xs-3"><button type="submit" name="slider" class="btn btn-block btn-info">Add to Slider</button></div>-->
                  ...
                  <input type="text" name="date" style="visibility:hidden" value="<?php $date= $_GET['date']; echo $date?>">
					...
					$posts = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM posts WHERE post_doc BETWEEN CAST('$date1' AS DATE) AND CAST('$date2' AS DATE) and trend='localnews' ORDER BY post_id DESC") or die(mysqli_error($GLOBALS["___mysqli_ston"])); 
					...
					?>
                      ...
                      <td><input class="checkbox1" type="checkbox" name="check[]" value="<?php echo $post_id ?>"  /></td>
                        <td><?php if($slider=="slider"){echo "<i class='fa fa-slideshare'></i>";}?> <a href="edit_localnews.php?post_id=<?php echo $post_id ?>"><?php echo $post_title ?></a></td>
                        ...
                        <td><a href="../localnews.php?post_id=<?php echo $post_id ?>&post_city=<?php echo $post_city ?>&post_state=<?php echo $post_state ?>&post_country=<?php echo $post_country ?>" target="_blank"><i class="fa fa-external-link"></i></a></td>
                      </tr>   
                    <?php }?>                               
                    </tbody>
                    <tfoot>
