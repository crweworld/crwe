...
$post_continent=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['continent']);
...
$count=mysqli_num_rows($sql);
	...
	if($post_continent==""){ $err_sin .="<i class=\"icon fa fa-info\"></i> Error!!! Location is Empty <br>";} 
	...
	$post_description=str_replace("textarea","",$post_description);
		$insert_ok = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `posts`(`cat_id`, `cat_status`, `post_title`, `post_description`, `source_url`, `post_doc`, `post_image_loc`, `post_status`, `post_continent`, `trend`, `admin_id`) VALUES ( '$cat_id2','$cat_status1', '$post_title', '$post_description', '$source_url', NOW(), '$post_image_loc', '$post_status', '$post_continent','trend_continent', '$admin_id')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		if($insert_ok == 1)
		{	
			$post_id=((is_null($___mysqli_res = mysqli_insert_id($GLOBALS["___mysqli_ston"]))) ? false : $___mysqli_res);			
			$post_location=$post_continent;
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Create Trending News Continent</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Create Trending News Continent</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <form role="form" action="" method="post">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add_post" class="btn btn-primary">Create Trending News Continent</button> 
