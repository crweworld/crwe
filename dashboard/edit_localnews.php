...
if(isset($_POST['delete_post']))
{
	...
	{
		echo "<script>
		alert('Local News Info Deleted Successfully');
		window.location.href='view_localnews.php';
		</script>";
	}
}
...
$err_sin="";
	...
	
	{
		...
		{
			echo clear();
			$done ="<i class=\"icon fa fa-info\"></i>Local News Updated Successfully. <br>";
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Update Local News</li>
          </ol>
        </section>
                ...
                <form role="form" action="" method="post">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="post_title" id="post_title" required="required" value="<?php if(isset($_SESSION['post_title'])){ echo $_SESSION['post_title']; } else { echo $post_title; }?>" placeholder="Enter Title" type="text">
                    </div>
                    <div class="form-group">
                      ...
                      <option value="">-Change Category-</option>
						...
						?>
                        <option <?php echo "value=\"$cat_id2\""; if(isset($_SESSION['cat_id2'])){ if($_SESSION['cat_id2']==$cat_result['cat_id']){echo "selected";}}else if($cat_name2==$cat_name){echo "selected";}?>><?php echo $cat_name2 ?></option>
                         <?php }?>
                      </select>
                     </div>
                    <div class="form-group">
                      <label for="Description">Description *</label>
                      <textarea class="ckeditor form-control" rows="10" cols="80" required id="editor1" name="post_description" ><?php if(isset($_SESSION['post_description'])){ echo $_SESSION['post_description']; } else { echo $post_description; }?></textarea>
         ...
         $(function() {
            ...
            $( "#automplete-1" ).autocomplete({
               source: availableTutorials
					...
					<?php echo ucfirst($post_city).", ".ucfirst($post_country) ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="radio">
                        <label>
                          <input name="post_status" value="publish" <?php if(isset($_SESSION['post_status'])){ if($_SESSION['post_status']=='publish'){echo 'checked';} } else if($post_status=="publish"){echo 'checked=""';}?> type="radio"> <span class="label label-success">Publish</span>
                        </label>
                      </div>
                      <?php /*?><div class="radio">
                        <label>
                          <input name="post_status"  value="unpublish" <?php if(isset($_SESSION['post_status'])){ if($_SESSION['post_status']=='unpublish'){echo 'checked';} } else if($post_status=="unpublish"){echo 'checked=""';}?> type="radio">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="edit_post" class="btn btn-primary">Update Local News Info</button> 
                    <button type="submit" name="delete_post" value="<?php echo $post_id ?>" class="btn btn-danger">Delete Local News Info</button>
                  </div>
                </form>
                <?php } ?>
              </div><!-- /.box -->
