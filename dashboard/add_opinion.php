...
$cat_id2=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['cat_id2']);
	...
	{	 $cat_id = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM category where `cat_id`='16'") or die(mysqli_error($GLOBALS["___mysqli_ston"])); 
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Create Opinion</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Create Opinion</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <form role="form" action="" method="post">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add_post" class="btn btn-primary">Create Opinion</button> 
