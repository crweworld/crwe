...
if ( isset( $_POST[ 'add_post' ] ) ) {
  ...
  elseif ( $post_description == "" ) {
    ...
    $insert_ok = mysqli_query( $GLOBALS[ "___mysqli_ston" ], "INSERT INTO `posts`(`cat_id`, `cat_status`, `post_title`, `post_description`,  `post_doc`,  `post_status`, `post_state`, `post_city`, `post_country`,  `zip_id`, `trend`, `user_id`) VALUES ( '$cat_id2','$cat_status1', '$post_title', '$post_description',  NOW(),  'publish', '$post_state', '$post_city', '$post_country', '$post_zipid','trend_country', '$user_id')" )or die( mysqli_error( $GLOBALS[ "___mysqli_ston" ] ) );
    if ( $insert_ok == 1 ) {
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2015 <a href="http://crweworld.com">www.crweworld.com</a>.</strong> All rights reserved. </footer>
