...
$rss = Feed::loadRss('http://www.environment.gov.au/minister/rss/environment.xml');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> SOURCE: Department of the Environment ( environment.gov.au )  Licensed from the Commonwealth of Australia under a Creative Commons Attribution 4.0 International. The Commonwealth of Australia does not necessarily endorse the content of this publication";
	$cat_id='1';
