...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.ninds.nih.gov%2FNews-Events%2FNews-and-Press-Releases%2FPress-Releases-feed.xml&key=413&hash=98d2bb06514bf34ab66c38b51cbdb59176ced5ea&max=10&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Source: National Institutes of Health (NIH) (nih.gov) ";
	$cat_id='15';
