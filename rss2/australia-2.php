...
$rss = Feed::loadRss('http://www.minister.border.gov.au/_layouts/SP.Minister/Rss.aspx?type=media&mini=peterdutton');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> SOURCE: DIBP ( border.gov.au )  Licensed from the Commonwealth of Australia under a Creative Commons Attribution 3.0 Australia Licence. The Commonwealth of Australia does not necessarily endorse the content of this publication";
	$cat_id='1';
