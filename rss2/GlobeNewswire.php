...
$rss = Feed::loadRss('http://www.globenewswire.com/rssfeed/OrgClass/1/Language/en/Content/FullText');
...
foreach ($rss->item as $item)
{
	...
	$post_description .='<br> <br><p><em>&copy; '.date("Y").' GlobeNewswire, Inc. All Rights Reserved.</em></p>';
	$post_description= mysqli_real_escape_string($GLOBALS["___mysqli_ston"], str_replace('href="/News/Listing?symbol=','target="_blank" href="http://globenewswire.com/News/Listing?symbol=',$post_description));
	$cat_id='35';
