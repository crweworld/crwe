...
$rss = Feed::loadRss('http://stickers.panarmenian.net/feeds/arm/news/');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Source: PanARMENIAN.Net  (licensed under a CC BY 3.0 License)";
	$cat_id='1';
	$post_country='armenia';
	$post_state='aparan';
	$post_city='aparan';
	$post_zipid='0301';
