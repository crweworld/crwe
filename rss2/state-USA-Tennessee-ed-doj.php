...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.justice.gov%2Ffeeds%2Fjustice-news.xml%3Ftype%255Bpress_release%255D%3Dpress_release%26component%255B2061%255D%3D2061%26organization%3D186146&key=413&hash=c697a2430ffad46fd5b7bc333e50f1c955e0f2d6&max=5&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>Eastern District of Tennessee<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='tn';
	$post_city='adams';
