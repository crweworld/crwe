...
$rss = Feed::loadRss('http://www.brandpointcontent.com/PrintSite/CategoryFeed.aspx?CategoryId=367&MemberId=89810&format=rss2');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Source: BrandPoint";
	$cat_id='17';
