...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.ice.gov%2Frss%2Fice-breaking-news&key=413&hash=2c25ddda953572669fc41f1babe3cc2d5e4a0935&max=10&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Source: U.S. Immigration and Customs Enforcement (ICE.gov)";
	$cat_id='1';
	$post_country='usa';
	$post_state='holtsville';
