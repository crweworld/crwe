...
$rss = Feed::loadRss('https://feeds.rijksoverheid.nl/nieuws.rss');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Nieuwsberichten op Rijksoverheid.nl";
	$cat_id='1';
	$post_country='netherlands';
	$post_state='drenthe';
	$post_city='aa-en-hunze';
	$post_zipid='9446-pa';
