...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.justice.gov%2Ffeeds%2Fjustice-news.xml%3Ftype%255Bpress_release%255D%3Dpress_release%26component%255B1691%255D%3D1691%26organization%3D185776&key=413&hash=d9d13d2039affba6732ed30d86d12b7bda88b23b&max=5&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>Middle District of Alabama<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='al';
	$post_city='moody';
