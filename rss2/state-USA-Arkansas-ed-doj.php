...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.justice.gov%2Ffeeds%2Fjustice-news.xml%3Ftype%255Bpress_release%255D%3Dpress_release%26component%255B1706%255D%3D1706%26organization%3D185801&key=413&hash=482e347ac3ac93d806361172596f085a83213e2d&max=5&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>Eastern District of Arkansas<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='ar';
	$post_city='pine-bluff';
	$post_zipid='71601';
