...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.justice.gov%2Ffeeds%2Fjustice-news.xml%3Ftype%255Bpress_release%255D%3Dpress_release%26component%255B2036%255D%3D2036%26organization%3D186121&key=413&hash=9e7b48536679d3318fd6689baf0180b22a14e647&max=5&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>Western District of Pennsylvania<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='pa';
	$post_city='aliquippa';
