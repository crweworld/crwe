...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>Middle District of Louisiana<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='la';
	$post_city='metairie';
