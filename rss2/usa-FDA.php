...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.fda.gov%2Fabout-fda%2Fcontact-fda%2Fstay-informed%2Frss-feeds%2Fpress-releases%2Frss.xml&key=413&hash=7039fc575f87b39b9ce93e4d2e0fae88d6717c08&max=10&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Source: U.S. Food and Drug Administration (FDA.gov)";
	$cat_id='24';
	$post_country='usa';
	$post_state='ny';
