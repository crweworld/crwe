...
$rss = Feed::loadRss('http://www.moneycontrol.com/rss/latestnews.xml');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Latest News from Moneycontrol.com";
	$cat_id='1';
	$post_country='india';
	$post_state='andaman-nicobar-islands';
	$post_city='nicobar';
	$post_zipid='744301';
