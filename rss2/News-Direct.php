...
$rss = Feed::loadRss( 'http://feeds.newsdirect.com/rss/' );
...
foreach ( $rss->item as $item ) {
	...
	$post_doc = date( 'Y-m-d', strtotime( $item->pubDate ) );
	$post_description = mysqli_real_escape_string( $GLOBALS[ "___mysqli_ston" ], $item->description );
	$post_description .= '<br> <br><p><em>&copy; ' . date( "Y" ) . ' News Direct Corp. All rights reserved.</em></p>';
	$cat_id = '49';
