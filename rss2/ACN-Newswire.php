...
$rss = Feed::loadRss('http://www.acnnewswire.com/rss/lang/ACNEng.xml');
...
foreach ($rss->item as $item)
{
	...
	$post_doc= date_format(date_create_from_format("m-d-Y",substr($item->pubdate,0,10)),"Y-m-d");
	$post_description=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $item->body);
	 	
	$post_description .='<br> <br><p><em>&copy; '.date("Y").' ACN Newswire. All rights reserved. A division of Asia Corporate News Network.</em></p>';
	$cat_id='47';
