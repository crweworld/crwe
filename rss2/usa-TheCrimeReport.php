...
$rss = Feed::loadRss('http://thecrimereport.org/feed/');
...
foreach ($rss->item as $item)
{
	...
	$post_description .='<br> <br> Source: The Crime Report ( <a href="https://thecrimereport.org/" target="_blank">TheCrimeReport.org</a> )';
	$cat_id='1';
	$post_country='usa';
	$post_state='ny';
