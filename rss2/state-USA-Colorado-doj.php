...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.justice.gov%2Ffeeds%2Fjustice-news.xml%3Ftype%255Bpress_release%255D%3Dpress_release%26component%255B1741%255D%3D1741%26organization%3D185831&key=413&hash=745adb1f15648f41b61b992e90baf70f696806e6&max=5&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>District of Colorado<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='co';
	$post_city='arvada';
