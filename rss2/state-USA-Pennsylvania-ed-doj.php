...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>Eastern District of Pennsylvania<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='pa';
	$post_city='aliquippa';
