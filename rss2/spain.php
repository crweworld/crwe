...
$rss = Feed::loadRss('http://www.aemet.es/en/noticias.rss');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Información elaborada por la Agencia Estatal de Meteorología. Ministerio de Agricultura, Alimentación y Medio Ambiente (AEMET)";
	$cat_id='1';
	$post_country='spain';
	$post_state='andalucia';
	$post_city='almeria';
	$post_zipid='04001';
