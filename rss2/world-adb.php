...
$rss = Feed::loadRss('http://feeds.feedburner.com/adb_publications?format=xml');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Source: Publications from the Asian Development Bank (ADB.org)";
	$cat_id='2';
