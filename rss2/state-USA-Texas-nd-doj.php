...
$rss = Feed::loadRss('http://fullcontentrss.com/feed.php?url=https%3A%2F%2Fwww.justice.gov%2Ffeeds%2Fjustice-news.xml%3Ftype%255Bpress_release%255D%3Dpress_release%26component%255B2081%255D%3D2081%26organization%3D186166&key=413&hash=698580960eeed8c8687048e10edff06b1e803338&max=5&links=preserve&exc=');
...
foreach ($rss->item as $item)
{
	...
	$post_description .="<br> <br> Department of Justice<br> Office of the U.S. Attorney<br>Northern District of Texas<br> <br> Source: Justice.gov";
	$cat_id='1';
	$post_country='usa';
	$post_state='tx';
	$post_city='austin';
