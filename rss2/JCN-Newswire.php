...
$rss = Feed::loadRss('http://www.jcnnewswire.com/rss/JCNEng.xml');
...
foreach ($rss->item as $item)
{
	...
	$post_description .='<br> <br><p><em>&copy; '.date("Y").' JCN Newswire. All rights reserved. A division of Japan Corporate News Network.</em></p>';
	$cat_id='48';
