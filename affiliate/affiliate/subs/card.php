...
<div style="max-width: 113px;max-height: 113px;overflow: hidden;"><img border="0" src="<?php echo $results['profile_pic']?>" style="border: 0;display: block;/* height: 113px; */line-height: 0px;/* max-height: 113px; */max-width: 113px;min-height: 113px;min-width: 113px;width:  100%;" /></div>
<?php } else { ?>
