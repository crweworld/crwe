...
$(function() {
    $('.overlay-menu ul li a,.scroll-top a, .join').bind('click', function(event) {
        var $anchor = $(this);
...
$(function() {
    ...
    $("#registerForm").validate({
        ...
        messages: {
            ...
            tnc: {
                required: "Please Agree to Our Term and Conditions"
        ...
        submitHandler: function(element) {
            ...
            $(ajaxform).find('[name="register"]').html('<i class="fa fa-circle-o-notch fa-spin fa-fw"></i> Sending...');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.type == 'success') {
                        $("#registerForm").before("<div class='alert alert-success' role='alert'><a href='#' class='close' data-dismiss='alert'>&times;</a>" + response.text + "</div>");
                        
                            $(this).remove('label.valid');
							$("#registerForm").addClass("hide_me");
                      
                    } else if (response.type == 'error') {
                        $("#registerForm").before("<div class='alert alert-danger' role='alert'><a href='#' class='close' data-dismiss='alert'>&times;</a>" + response.text + "</div>");
                        $(ajaxform).find('[name="register"]').html('<i class="fa fa-check-square-o fa-fw"></i> Register Me');
                    }
                }
            });
...
$(function() {
    ...
    $("#resetForm").validate({
        ...
        submitHandler: function(element) {
            ...
            $(ajaxform).find('[name="reset"]').html('<i class="fa fa-circle-o-notch fa-spin fa-fw"></i> Sending...');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.type == 'success') {
                        $("#resetForm").before("<div class='alert alert-success' role='alert'><a href='#' class='close' data-dismiss='alert'>&times;</a>" + response.text + "</div>");                        
                            $(this).remove('label.valid');
							$("#resetForm").addClass("hide_me");
                        
                    } else if (response.type == 'error') {
                        $("#resetForm").before("<div class='alert alert-danger' role='alert'><a href='#' class='close' data-dismiss='alert'>&times;</a>" + response.text + "</div>");
                        $(ajaxform).find('[name="reset"]').html('<i class="fa fa-check-square-o fa-fw"></i> Send My Password');
                    }
                }
            });
