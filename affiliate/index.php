...
<script type="text/javascript">
    var CaptchaCallback = function(){
        grecaptcha.render('register_cap', {'sitekey' : '6LdqmCgTAAAAAAzjJGJzYhPgP5JZjlIY4-nDcFDx'});
        grecaptcha.render('contact_cap', {'sitekey' : '6LdBghwTAAAAAIU00Y1057N9erWtw9v4aNUrZAgV'});
    };
</script>
</head>
...
<body id="home">
          ...
          <nav class="navbar navbar-custom navbar-fixed-top top-nav-collapse" role="navigation">
                <div class="container">
                    ...
                    <form class="form-inline" id="loginForm" name="loginForm" method="post" action="#" style="float: right;padding: 0px 25px;">                   
                        ...
                        <button type="submit" name="login" class="btn btn-default"  style="padding: 8px 5px; background:none; border: 1px solid;">Login</button>    
                    </form>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item html5-video-container active">
                        <!-- HTML5 Video -->
                       <div class="fill" style="background-image:url('assets/images/typing-on-mac.jpg');"></div>
                        <div class="carousel-caption">
                        <iframe width="622" height="350" src="https://www.youtube.com/embed/yrrQ1fBJhg8?autoplay=1&rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
                            <h1 class="animated slideInDown"><span style="color: #197CD9;">Earn Money</span> by becoming a <span style="color:#000;text-shadow: #fff 0px 0px 50px;">CRWE</span> <span style="color:#F00">WORLD</span>Affiliate. <span style="color: #197CD9;">BE YOUR OWN BOSS</span></h1>
                           
                            <a href="#reg" class="register-btn join btn btn-default btn-lg">Simple & Free to Join</a>
                        </div>
                ...
                <a href="#reg" class="join"> <div class="mouse"></div> </a>
            </header>
                       ...
                       <div class="register-form col-xs-6">
                           ...
                           <form class="ajax-form" id="registerForm" method="post" action="assets/php/register.php">
                                ...
                                <div class="form-group">
                               	...
                               	<div class="form-group">  
                                <div id="register_cap"></div>                                  
                                          
                                 </div>
                                <div class="form-group">
                                            <label>
                                                <input id="tnc"  name="tnc" value="1" type="checkbox" required> I agree to the CRWE WORLD  Affiliate Program <a style="color: #197cd9;" target="_blank" href="agreement.php">Terms</a>
                                            </label>
                                </div>
                                <div class="form-group">
            ...
            <section id="services" class="services content-section">
                <div class="container">
                    <div class="row text-center">
                        ...
                        <div class="container">
                            <div class="row text-center">
                            <a class="register-btn join" href="#reg">
                                <div class="col-md-3">
							 ...
							 <a target="_blank" href="how_it_works.php">
                                <div class="col-md-3">
                                    <div class="row services-item sans-shadow text-center">
                                        <i class="fa fa-line-chart fa-3x"></i>
                                        <h4>Learn About The Services</h4>
                                        <p>Knowledge of services can increase sells</p>
                                    </div><!-- /.row -->
                                </div><!-- /.col-md-4 -->
                                </a>
                                ...
                                <div class="col-md-3">
                                    <div class="row services-item sans-shadow text-center">
                                        ...
                                        <h4>Promote, Sell and Earn Commission</h4>
                                        <p>Promote and Sell CRWE WORLD Services</p>
                                    </div><!-- /.row -->
                                </div><!-- /.col-md-4 -->
                                </a>
                               ...
                               <p style="color:#fff">Apply through our secured online form. Approval in 24 hours.</p>
  ...
  <tr>
    <td style="border-top:#000 1px solid; text-align:center">HER PROFIT</td>
                                            ...
                                            <p align="center"><img class="transparent" alt="https://affiliate.crweworld.com/assets/images/emma_business_card.png" src="https://affiliate.crweworld.com/assets/images/emma_business_card.png" /></p>
                                        </div><!-- /.item -->
...
Affiliate marketing is considered to be one of the world's fastest growing and best marketing techniques to earn money on and off line.
                                    ...
                                    <section>
                                        <h2 class="acc_title_bar theme-blue-title-bar nav_arrow"><a href="#">Why should I get business cards?</a></h2>
                                        <div style="" class="acc_container">
                                            <div style="opacity: 1;" class="block animated fadeInDown">
                                                                 
                                                <p style="padding: 10px 5px; font-size: 16px;">They are an effective marketing tool <br>
1. Never miss an opportunity to make a valuable business connection. <br>
2. Create a great first impression and they also act as a great icebreaker. <br>
3. Shows that you are prepared. <br>
...
Affiliates will be paid a 50% commission fee for selected service generated through CRWE WORLD. Other 3rd party services will have a different pay out. </p>
                                            </div>
                                        </div>
                                    </section>
                                    <section>
                ...
                <div class="container project-container text-center">
                    <div class="recent-project-carousel owl-carousel owl-theme popup-gallery">
                        ...
                        <div class="item recent-project">
                            ...
                            <div class="full-project">
                                <a target="_blank" href="http://crwetube.com/" >Visit Site <i class="fa fa-chevron-right"></i></a>
                            </div><!-- /.full-project -->
                        </div><!-- /.item -->
                ...
                <div class="container">
                    <div class="row form-container">
                            ...
                            <form class="ajax-form" id="contactForm" method="post" action="assets/php/contact.php">
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-5" style="float:right">      
                                 	<div id="contact_cap" required></div>                              
                        ...
                        <div class="col-md-4 contact-address">
                            <h3>Our address</h3>
                            <p>11226 Pentland Downs St,<br>Las Vegas, NV 89141</p>
                            <ul>
