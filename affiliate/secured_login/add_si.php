...
$err_sin="";
	...
	if(empty($err_sin)) 
	{
		...
		$insert_ok = mysql_query("INSERT INTO `service`(`serv_info`, `serv_add`, `serv_price`,`serv_type`, `serv_doc`, `serv_status`,`cs_id`,`cs_status`) VALUES ('$serv_info', '$serv_add', '$serv_price', '$serv_type', '$serv_doc', '$serv_status', '$cs_id2', '$cs_status1')")or die(mysql_error());
		if($insert_ok == 1)
		{
			$done ="<i class=\"icon fa fa-info\"></i> Service Rate Created Successfully. <br>";
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Create Service Rate</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Create Service Rate</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
              ...
              <?php } ?>
                ...
                <form action="#" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <option value="">-Change Category-</option>
						...
						?>
                        <option <?php echo "value=\"$cs_id2\""; ?>><?php echo $cs_name2 ?></option>
                         <?php }?>
                      </select>
                     </div>
                    <div class="form-group">
                      <label>Service Rate Info *</label>
                      <textarea class="form-control" name="serv_info"  required="required"  placeholder="Enter Service Rate Info"></textarea>
                      
                     
                    </div>
                    <div class="form-group">
                      <label>Service Rate Additional Info</label>
                      <input class="form-control" name="serv_add"  placeholder="Service Rate Additional Info" type="text">
                    </div>
                  <div class="form-group">
                      <label>Price* (USD)</label>
                      <input class="form-control" required="required" name="serv_price"  placeholder="Enter Price" type="text">
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="radio">
                        <label>
                          <input name="serv_type" checked value="1" type="radio"> <span class="label label-success">Show Buy Button</span>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input name="serv_type"  value="0"  type="radio">
                    ...
                    <div class="form-group">
                      ...
                      <div class="radio">
                        <label>
                          <input name="serv_status" checked value="1" type="radio"> <span class="label label-success">Publish</span>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input name="serv_status"  value="0"  type="radio">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add_serv" class="btn btn-primary">Create Service Rate</button> 
